...
@section('content')
    ...
    {!! Form::open(['action' => ['App\Http\Controllers\PostsController@update', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        ...
        <div class="form-group mb-3">
            ...
            {{Form::select('department', ['Computer Science'=>'Computer Science', 'Computer Science Education'=>'Computer Science Education'], $post->department, ['class' => 'form-control bg-white', 'placeholder' => 'Department'])}}
        </div>
        <div class="form-group mb-3">
            {{Form::label('faculty', 'Faculty', ['class' => 'form-label'])}}
            {{Form::select('faculty', ['Education'=>'Education', 'Science'=>'Science'], $post->faculty, ['class' => 'form-control bg-white', 'placeholder' => 'Faculty'])}}
        </div>
        <div class="form-group mb-3">
